...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" className="relative py-24 bg-zinc-900/30">
      {/* Background accent */}
          ...
          <div>
            ...
            <div className="relative">
              ...
              {experiences.map((exp, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-0 top-2 w-4 h-4 bg-zinc-950 border-2 border-cyan-500 rounded-full" />

                  <div className="p-5 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800 hover:border-cyan-500/30 rounded-xl transition-all duration-300">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.tech.map((tech) => (
                        <span
                          key={tech}
                          className="px-2 py-1 text-xs font-mono bg-cyan-500/10 text-cyan-400 rounded"
                        >
                          {tech}
                        </span>
                      ))}
              ...
              {education.map((edu, index) => (
                ...
                >
                  ...
                  <div className="p-5 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800 hover:border-cyan-500/30 rounded-xl transition-all duration-300">
                    ...
                    <p className="text-sm text-zinc-500 mb-3">{edu.details}</p>
